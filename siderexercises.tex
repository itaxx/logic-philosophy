...
{\footnotesize
\begin{enumerate}
	\item $(\sim P\rightarrow((\sim P\rightarrow \sim P)\rightarrow \sim P))\rightarrow \\ ((\sim P\rightarrow(\sim P\rightarrow \sim P))\rightarrow(\sim P\rightarrow \sim P))$ \hfil PL2
	\item $\sim P\rightarrow ((\sim P\rightarrow \sim P)\rightarrow \sim P)$ \hfil PL1
	\item $(\sim P\rightarrow (\sim P\rightarrow \sim P))\rightarrow(\sim P\rightarrow \sim P)$ \hfil 1,2,MP
	\item $\sim P\rightarrow (\sim P\rightarrow \sim P)$ \hfil PL1
	\item $\sim P\rightarrow \sim P$ \hfil 3,4 MP
	\item $(\sim P\rightarrow \sim P)\rightarrow(\sim P\rightarrow P)\rightarrow P$ \hfil PL3 
	\item $(\sim P\rightarrow P)\rightarrow P$ \hfil 5,6,MP
\end{enumerate}}
